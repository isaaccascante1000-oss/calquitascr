  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ color: '#fff', marginBottom: '8px', fontSize: '1.5rem' }}>Registro de Usuario</h2>
        ...
        <div style={{ marginTop: '20px', textAlign: 'center' }}>
          <p style={{ color: '#8b949e', fontSize: '0.9rem' }}>
            ¿Ya tienes cuenta? <Link to="/login" style={{ color: '#4F46E5', textDecoration: 'none' }}>Inicia sesión</Link>
          </p>
        </div>
      </div>
    </div>
